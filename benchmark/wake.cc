...
static inline int futex_wait(u_int32_t *uaddr, u_int32_t val, struct timespec *timeout, int opflags) {
...
static void benchmark_futex(int core1, int core2) {
    ...
    std::cout << "Call futex_wake, avg overhead " << duration / kLoop << "ns" << std::endl;
